...
class TaskParametersUtility {
    static GetParameters() {
        ...
        let params = {
            ...
            isLatest: isLatest,
            cloneOptions: {
                tags: tl.getBoolInput('dtrackCloneTags', false),
                properties: tl.getBoolInput('dtrackCloneProperties', false),
                services: tl.getBoolInput('dtrackCloneServices', false),
                acl: tl.getBoolInput('dtrackCloneACL', false),
                components: tl.getBoolInput('dtrackCloneComponents', false),
                findings: tl.getBoolInput('dtrackCloneFindings', false),
                auditHistory: tl.getBoolInput('dtrackCloneAuditHistory', false),
                policyViolations: tl.getBoolInput('dtrackClonePolicyViolations', false),
                policyViolationsAuditHistory: tl.getBoolInput('dtrackClonePolicyViolationsAuditHistory', false),
            },
